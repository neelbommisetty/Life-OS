...
| Inbox | Inbox capture and item lifecycle controls | `/inbox` | Users can capture inbox items, review details, mark processed, and archive from the inbox view | `Automated`: create/list/detail plus process/archive action coverage |
