...
const DEFAULT_GEMINI_MODEL_CONFIGS: readonly GeminiModelDefinitionConfig[] = [
  {
    key: ModelKeyName.GoogleGemini31ProPreview,
    modelId: 'gemini-3.1-pro-preview',
    label: 'Google Gemini 3.1 Pro (Preview)',
    description: 'Latest Gemini 3.1 Pro preview model for advanced multimodal reasoning, coding, and broad world-knowledge tasks.',
    ...
    tags: ['gemini-3.1', 'pro', 'preview'],
  },
  {
    key: ModelKeyName.GoogleGemini31FlashLitePreview,
    modelId: 'gemini-3.1-flash-lite-preview',
    label: 'Google Gemini 3.1 Flash-Lite (Preview)',
    description: 'Cost-efficient Gemini 3.1 preview model for high-throughput chat, transforms, and lightweight multimodal tasks.',
    releaseStage: 'experimental',
    maxOutputTokens: 65536,
    contextWindow: 1048576,
    ...
    tags: ['gemini-3.1', 'flash-lite', 'preview'],
  },
  {
    key: ModelKeyName.GoogleGemini3FlashPreview,
    modelId: 'gemini-3-flash-preview',
    label: 'Google Gemini 3 Flash (Preview)',
    description: 'Fast Gemini 3 preview model for multimodal reasoning with lower latency than the Pro tier.',
    releaseStage: 'experimental',
    maxOutputTokens: 65536,
    contextWindow: 1048576,
