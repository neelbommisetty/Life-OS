...
const DEFAULT_OPENAI_MODEL_CONFIGS: readonly OpenAIModelDefinitionConfig[] = [
  {
    ...
    description: 'Current flagship GPT-5.4 model for complex reasoning, coding, and agentic workflows.',
    releaseStage: 'ga',
  ...
  {
    key: ModelKeyName.OpenAIGpt54Mini,
    modelId: 'gpt-5.4-mini',
    label: 'OpenAI GPT-5.4 Mini',
    description: 'Stronger lower-latency GPT-5.4 variant for coding, computer use, and subagent workloads.',
    releaseStage: 'ga',
    maxOutputTokens: 128000,
    ...
    pricing: {
      inputUsdPer1m: 0.75,
      cacheReadInputUsdPer1m: 0.075,
      outputUsdPer1m: 4.5,
      effectiveAt: '2026-04-18',
    },
    tags: ['gpt-5.4', 'mini', 'responses'],
  },
  {
    key: ModelKeyName.OpenAIGpt54Nano,
    modelId: 'gpt-5.4-nano',
    label: 'OpenAI GPT-5.4 Nano',
    description: 'Cheapest GPT-5.4-class model for simple, high-volume tasks and lightweight transforms.',
    releaseStage: 'ga',
    maxOutputTokens: 128000,
    contextWindow: 400000,
    ...
    pricing: {
      inputUsdPer1m: 0.2,
      cacheReadInputUsdPer1m: 0.02,
      outputUsdPer1m: 1.25,
      effectiveAt: '2026-04-18',
    },
    tags: ['gpt-5.4', 'nano', 'responses'],
  },
];
